...
export default function Weddings() {
    ...
    return (
        <div className="flex flex-col ">
            <PhotoStyleBanner title="Wedding photograher in Brussels" imgUrl="../../jpg/wedding/DSC_0071.jpg" />
            <div className="mt-8 sm:max-w-xl md:max-w-3xl lg:max-w-4xl xl:max-w-6xl mx-auto px-4 md:px-12 py-2 md:py-8  flex flex-col ">
                <div className="flex flex-col md:flex-row justify-between ">
                    ...
                    <Image height={600} width={600} src="/jpg/wedding/wedding-shooting.jpg" alt="" className="bg-cover pt-8 md:pt-0 h-60 md:h-[500px] w-full object-cover bg-center bg-no-repeat" />
                </div>
