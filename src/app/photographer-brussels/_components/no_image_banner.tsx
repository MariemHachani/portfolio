...
export default function NoImageBanner(params: { title: string, subtitle: string }) {
    ...
    return (
        <div ref={ref1} className="bg-lightpink ">
            <div className={`flex flex-col items-center justify-center sm:max-w-xl md:max-w-3xl lg:max-w-4xl xl:max-w-6xl  px-4 md:px-12 py-2 md:py-8 
                transition-all  duration-1000 ${isVisible1 ? " translate-x-10 opacity-100 " : "opacity-0 -translate-x-10"}`}>
                ...
                <div className={`my-8 w-1/4 delay-1000 transition-all   ${isVisible1 ? "duration-1000 translate-x-10 opacity-100 " : "opacity-0 -translate-x-10"}`}>
